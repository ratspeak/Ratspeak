...
var activityPath = path.join(__dirname, '..', '..', 'dashboard', 'static', 'js', 'activity.js');
var statePath = path.join(__dirname, '..', '..', 'dashboard', 'static', 'js', 'state.js');
var indexPath = path.join(__dirname, '..', '..', 'dashboard', 'index.html');
