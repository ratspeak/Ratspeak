...
var channelsSource = fs.readFileSync(
    path.join(__dirname, '..', '..', 'dashboard', 'static', 'js', 'channels.js'),
    'utf8'
);
var contactCardSource = fs.readFileSync(
    path.join(__dirname, '..', '..', 'dashboard', 'static', 'js', 'contact_card.js'),
    'utf8'
);
var nativeShareSource = fs.readFileSync(
    path.join(__dirname, '..', '..', 'dashboard', 'static', 'js', 'native_channel_share.js'),
    'utf8'
);
