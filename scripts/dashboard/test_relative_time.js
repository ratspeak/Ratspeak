...
// against a stubbed window. Run: node scripts/dashboard/test_relative_time.js
...
var src = fs.readFileSync(path.join(__dirname, '..', '..', 'dashboard', 'static', 'js', 'state.js'), 'utf8');
