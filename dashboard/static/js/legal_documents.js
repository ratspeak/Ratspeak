...
(function() {
    ...
    var DOCUMENTS = Object.freeze({
        privacy: {
            ...
            meta: 'Effective August 7, 2026 · Ratspeak LLC',
            url: URLS.privacy,
            content: `
                <section>
                    ...
                    <div class="rs-legal-principles">
                        ...
                        <div><strong>No ad tracking</strong><span>Ratspeak does not include advertising SDKs, cross-app tracking, or behavioral analytics.</span></div>
                ...
                <section><h2>Propagation nodes and relays</h2><p>A propagation node can temporarily store encrypted LXMF payloads so a recipient can retrieve them later. Ratspeak LLC operates some propagation nodes listed in the app’s node directory. Those nodes may process encrypted payloads and the protocol metadata needed to queue, route, limit abuse, and expire traffic. Independent propagation nodes are controlled by their own operators.</p><p>Ratspeak-operated propagation nodes are not intended to read the content of end-to-end encrypted direct messages. Queued traffic is removed as it is delivered, expires, or is removed under operational limits. Exact network copies may also exist on independently operated infrastructure outside our control.</p></section>
                ...
                <section><h2>Website, downloads, and support</h2><p>Our website host and security providers may process ordinary request information such as IP address, time, requested page, browser details, and security signals. We use this information to deliver and protect the site, not to build advertising profiles.</p><p>If you email mail@ratspeak.org, submit a safety report, or send beta feedback, we receive the information you choose to provide, your email address, and related correspondence. Channel reports are prepared for your review and are not sent automatically.</p></section>
        ...
        terms: {
            ...
            content: `
                ...
                <section><h2>Adults only</h2><p>You must be at least 18 years old and legally able to enter this agreement. Ratspeak is not marketed to children and may not be used by anyone under 18. Do not use Ratspeak on behalf of a child or enable a child to access its public-channel features.</p></section>
                ...
                <section><h2>Acceptable use</h2><p>You may not use Ratspeak or an official Ratspeak service to:</p><ul><li>exploit, endanger, sexualize, groom, or solicit a child;</li><li>make credible threats, coordinate violence, stalk, harass, or expose another person’s private information;</li><li>distribute malware, phishing, fraudulent material, spam, or traffic intended to disrupt a network or device;</li><li>impersonate another person or falsely present an independent service as an official Ratspeak service;</li><li>infringe intellectual-property, privacy, or other legal rights;</li><li>evade access controls, abuse limits, moderation, or safety measures; or</li><li>violate applicable law or facilitate another person’s violation.</li></ul><p>The fuller behavioral standard is in the <button type="button" class="rs-legal-inline-link" data-legal-document="guidelines">Community Guidelines</button>.</p></section>
        ...
        guidelines: {
            ...
            meta: 'Effective August 7, 2026 · Adults 18+ only',
            url: URLS.guidelines,
            content: `
                <section><h2>Where these guidelines apply</h2><p>These Guidelines apply to your use of the Ratspeak app and official Ratspeak services. They also describe the standard we use when evaluating app safety reports and deciding whether infrastructure should appear in an official Ratspeak directory.</p><div class="rs-legal-notice"><strong>Not every hub is ours</strong><p>Independent channel hubs and other Reticulum infrastructure are run by their own operators. Ratspeak LLC cannot continuously monitor, moderate, or remove content from systems it does not control.</p></div><p>Ratspeak is for adults age 18 and older. Children may not use the app or its public-channel features.</p></section>
                ...
                <section><h2>Content and conduct never allowed</h2><ul><li><strong>Child sexual abuse and exploitation:</strong> any sexualization, grooming, solicitation, trafficking, or exploitative material involving a minor.</li><li><strong>Credible violence or harm:</strong> threats, instructions directed at a specific target, celebration of imminent harm, or coordination of violent acts.</li><li><strong>Targeted abuse:</strong> stalking, sustained harassment, non-consensual sexual content, hateful attacks, or encouragement of self-harm.</li><li><strong>Private information:</strong> doxxing, credential theft, intimate imagery shared without consent, or exposure of information that creates a safety risk.</li><li><strong>Fraud and technical abuse:</strong> impersonation, scams, phishing, malware, spam, deliberate denial of service, or attempts to bypass safety and access controls.</li><li><strong>Illegal material:</strong> content or conduct that violates applicable law or infringes another person’s rights.</li></ul></section>
