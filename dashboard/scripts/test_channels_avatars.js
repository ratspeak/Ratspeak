...
assert(indexSource.includes('/static/style.css?v=ui-20260815-6'));
assert(indexSource.includes('/static/js/nav.js?v=ui-20260815-6'));
assert(indexSource.includes('/static/js/ui_shared.js?v=ui-20260815-6'));
assert(indexSource.includes('/static/js/lxmf.js?v=ui-20260815-6'));
assert(indexSource.includes('/static/js/channels.js?v=ui-20260815-6'));
assert(indexSource.includes('/static/js/channel_hub.js?v=ui-20260815-6'));
