...
fn text_scale_presets_are_durable_and_backend_validated() {
    ...
    assert!(index.contains("/static/style.css?v=ui-20260906-1"));
...
fn voice_and_capture_paths_preflight_media_permissions() {
    ...
    let index = read_source(root.join("dashboard/index.html")).expect("dashboard index");
    assert!(index.contains("/static/js/state.js?v=ui-20260906-1"));
    assert!(index.contains("/static/js/voice_ringtones.js?v=ui-20260906-1"));
    assert!(index.contains("/static/js/lxmf.js?v=ui-20260906-1"));
    assert!(index.contains("/static/js/tauri_events.js?v=ui-20260906-1"));
